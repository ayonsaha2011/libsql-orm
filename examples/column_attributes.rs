...
/// to specify custom column properties and constraints in a Cloudflare Worker environment.

use worker::*;
use libsql_orm::{Model, Database, generate_migration, MigrationManager, orm_column};
...
async fn main(req: Request, env: Env, _ctx: Context) -> Result<Response> {
    ...
    println!("✓ Created {} products with constraints", created_products.len());
    ...
    Response::ok("✅ Column attributes example completed successfully!")
}